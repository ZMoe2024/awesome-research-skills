...
[![加入科研 AI 社区｜联系 Moe 申请｜说明研究方向和加入目的，人工审核通过后邀请加入](assets/join-research-community.svg)](https://skill.createsci.com/community)

> **[👉 联系我，申请加入社区](https://skill.createsci.com/community)** · 请说明研究方向和加入目的，审核通过后邀请加入。
